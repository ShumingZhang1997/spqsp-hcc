...
public:
	...
	//! get suppression from PD1_PDL1 concentration
	static double get_PD1_supp(double concentration, double n);
	...
	static double get_exhaust_prob_Treg(double q);
	...
	BioFVMSinkSource*& get_sink_IL_2(void) { return _sink_IL_2; };
	//! T cell to stream
